...
namespace Edge.Data.Objects
{
	...
	{
		public static EntityDefinition<ChannelSpecificObject> Definition = new EntityDefinition<ChannelSpecificObject>(baseDefinition: EdgeObject.Definition, fromReflection: true);
