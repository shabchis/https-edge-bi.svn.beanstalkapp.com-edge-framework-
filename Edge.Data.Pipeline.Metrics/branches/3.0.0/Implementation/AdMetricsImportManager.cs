...
namespace Edge.Data.Pipeline.Metrics.Implementation
{
	...
	{
		public AdMetricsImportManager(Guid serviceInstanceID, MetricsDeliveryManagerOptions options = null)
			: base(serviceInstanceID, options)
		{
			var hasMeasureOptions = Options.MeasureOptions != MeasureOptions.None;
			Options.MeasureOptions = hasMeasureOptions ? Options.MeasureOptions : MeasureOptions.All;
